# FinTechBankX Service Catalog

Generated from repository bootstrap manifest.

| Repository | Bounded Context | Service ID | Application ID | Production DB Pattern | Event Namespace | Owning Squad | Wave |
| --- | --- | --- | --- | --- | --- | --- | ---: |
