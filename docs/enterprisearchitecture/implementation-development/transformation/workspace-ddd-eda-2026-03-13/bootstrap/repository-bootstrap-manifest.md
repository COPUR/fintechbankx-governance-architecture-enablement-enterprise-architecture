# Repository Bootstrap Manifest (DDD + EDA)

## Purpose

This manifest starts transformation by defining target repositories with aligned:

1. Business context
2. Runtime service ID
3. Application ID
4. Data ownership target
5. Event namespace
6. Squad ownership
